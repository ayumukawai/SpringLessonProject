...
- **機能面を充実させる**：他機能と画面の追加(日付管理、フィルター機能、ソート機能、ファイルの読み書き、など)、Git管理とGitHubへのアップロード、`自分のPCのSQLへの接続`、`テストコード`の追加
...
- 発表 5 分、質疑応答 3 分程度（3分間スピーチと同様に 2 名指名。質問だけでなくディスカッションをおこなう）。1人あたり約 10 分 × 36 人。 ※現時点での想定
- 資料・システムの画面・ソースコードなどを見せながら発表する。
- **発表に含める内容の例：** 題材を選んだ経緯、システムの概要、創意工夫した点、苦労した点、これまでの研修の感想や今後のビジョンなど
- **提出物：** 開発したシステムのソースコード（zip）、プレゼン資料（PowerPoint など）
